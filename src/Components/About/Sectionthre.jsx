function Sectionthre() {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div className="bg-[#EAF8F2] rounded-[30px] p-10 flex flex-col md:flex-row items-center justify-between">
      <div className="max-w-md">
        ...
        <p className="mt-5 text-gray-600 leading-8">
          Explore thousands of online courses and improve your skills with expert instructors.
        </p>
      ...
      <img
        src="https://i.pinimg.com/1200x/0d/f4/cc/0df4ccfb5608ecc443327c18c4feeafa.jpg"
        alt="Student"
        className="w-56 mt-8 md:mt-0"
      />
    </div>
